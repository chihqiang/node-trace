 ...
 * 恢复离线事件
 */
declare function restoreOfflineEvents(): Promise<void>;
...
export { type BrowserData, type EventProperties, type IPlugin, type Options, type Payload, behaviorPlugin, behaviors, browserPlugin, browserUtils, clearID, clearTimers, errorPlugin, flush, generateStableDeviceIdAsync, getBrowserData, getDeviceId, getID, init, networkPlugin, pageviewPlugin, performancePlugin, plugins, restoreOfflineEvents, sessionPlugin, sessions, setID, storageUtils, track, use, userPlugin };
